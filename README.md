...
## 📌 Mission 0 : Mise en place de l’environnement de travail
- [x] Serveur Web  
- [x] Serveur Base de Données  
- [x] Serveur de Production  
- [x] Test de communication entre le serveur Web et la BDD  
...
### 📌 Mission 0 : Mise en place de l’environnement
| Tâche                    | Statut |
|---------------------------|--------|
| Serveur Web           | ✅ |
| Serveur BDD           | ✅ |
